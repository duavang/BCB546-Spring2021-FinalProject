...
TSAS.Output.Maggie...Sheet5 <- read.csv("2F TSAS Data.csv")
TSAS.Output.Maggie...Sheet5$"MappedReads(thousands)" <- TSAS.Output.Maggie...Sheet5$Mapped.Reads
TSAS.Output.Maggie...Sheet5$"UniqueHits(thousands)" <- TSAS.Output.Maggie...Sheet5$totaluniquehits
